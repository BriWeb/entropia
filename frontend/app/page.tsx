        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <Link href="/login" className="inline-block mt-6">
              <Button className="bg-black hover:bg-neutral-900 dark:bg-white dark:hover:bg-neutral-100 text-white dark:text-black px-8 py-2 text-sm rounded-full transition-colors">
                Empezar
              </Button>
            </Link>
          </div>
            ...
            {[
              {
                ...
                description: "Administra historiales médicos y datos personales de forma segura y eficiente",
                icon: (
              ...
              },
              {
                ...
                description: "Organiza y gestiona las consultas médicas de manera intuitiva",
                icon: (
              ...
              },
              {
                ...
                description: "Genera informes detallados y visualiza estadísticas en tiempo real",
                icon: (
              ...
              },
              {
                ...
                description: "Protección robusta para toda la información médica sensible",
                icon: (
