...
export default function DashboardDoctor() {
    ...
    const turnosHoy = [
        ...
        { id: 2, hora: '10:30', paciente: 'María García', estado: 'En sala', notas: 'Primera consulta' },
        { id: 3, hora: '11:45', paciente: 'Carlos López', estado: 'Atendido', notas: 'Seguimiento post-operatorio' },
        { id: 4, hora: '14:15', paciente: 'Ana Martínez', estado: 'Cancelado', notas: '-' },
    ];

    // turnos de ejemplo, despues se agrega de la base de datos
    const proximosTurnos = [
        { id: 5, fecha: '16/05/2023', hora: '09:15', paciente: 'Pedro Ramírez', notas: 'Control rutinario' },
        { id: 6, fecha: '16/05/2023', hora: '11:30', paciente: 'Lucía Sánchez', notas: 'Control de medicación' },
        { id: 7, fecha: '17/05/2023', hora: '10:00', paciente: 'Roberto González', notas: 'Revisión de estudios' },
        { id: 8, fecha: '17/05/2023', hora: '15:45', paciente: 'Sofia Torres', notas: 'Primera consulta' },
    ];
    ...
    const getEstadoColor = (estado: string) => {
        switch (estado) {
            ...
            case 'En sala': return 'bg-gray-200 text-gray-800';
