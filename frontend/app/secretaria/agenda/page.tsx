...
export default function AgendaPage() {
    ...
    const calendarDays = Array(daysInMonth).fill(0).map((_, index) => index + 1);
    
    // Eventos de ejemplo
    const events = [
        { day: 5, time: '09:00', patient: 'Juan Pérez', type: 'Consulta' },
        { day: 7, time: '10:30', patient: 'María López', type: 'Control' },
        { day: 12, time: '15:00', patient: 'Carlos Rodríguez', type: 'Tratamiento' },
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="mb-6">
                ...
                <p className="text-gray-500">Visualiza y gestiona los turnos programados</p>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                ...
                <div className="lg:col-span-2 bg-white rounded-lg shadow-md p-6">
                    ...
                    <div className="grid grid-cols-7 gap-1">
                        ...
                        {Array(firstDayOfMonth === 0 ? 6 : firstDayOfMonth - 1).fill(0).map((_, index) => (
                        ...
                        {calendarDays.map(day => {
                            ...
                            return (
                                <div 
                                    key={day} 
                                    className={`h-12 p-1 relative border border-gray-100 ${isToday ? 'bg-gray-100' : ''}`}
                                >
                                    <span 
                                        className={`
                        ...
                        {events.slice(0, 3).map((event, index) => (
                            <div key={index} className="border-l-4 border-gray-500 pl-4 py-2">
                                ...
                                <p className="text-sm text-gray-500">
                                    <span>{currentMonth} {event.day}, {event.time}</span> - {event.type}
                                </p>
                            </div>
                        ))}
