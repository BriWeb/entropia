        ...
        <div className="flex min-h-screen">
                    ...
                    <div className="h-full flex flex-col bg-white">
                        ...
                        <div className="flex-1 p-4">
                            <nav className="space-y-2">
                                <Link href="/secretaria/dashboard" className="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg">
                                    <LayoutDashboard size={20} />
                                    <span>Panel</span>
                                </Link>
                                <Link href="/secretaria/perfil" className="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg">
                                    <UserCircle size={20} />
                                    <span>Perfil</span>
                                </Link>
                                <Link href="/secretaria/agenda" className="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg">
                                    <Calendar size={20} />
                                    <span>Agenda</span>
                                </Link>
                                <Link href="/secretaria/turnos" className="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg">
                                    <Clock size={20} />
                                    <span>Turnos</span>
                                </Link>
                                <Link href="/secretaria/pacientes" className="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg">
                                    <Users size={20} />
                                    <span>Pacientes</span>
                                </Link>
                                <Link href="/secretaria/configuracion" className="flex items-center gap-2 p-2 hover:bg-gray-100 rounded-lg">
                                    <Settings size={20} />
            ...
            <div className="flex-1 flex flex-col w-full md:ml-64">
                ...
                <main className="p-4 bg-gray-100 flex-1 transition-all duration-300 relative">
                    ...
                    {children}{/*mi hijito contenido osea el home*/}
                </main>
            </div>
        </div>
    )
