            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-7">
                ...
                <div className="md:col-span-2">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
                        <Card>
                            <CardHeader>
                                <p className="text-sm text-gray-500">Turnos gestionados (mes)</p>
                                <CardTitle>
