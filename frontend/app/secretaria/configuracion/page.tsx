import { Settings, Bell, Shield, Users, Clock, Globe, HelpCircle } from 'lucide-react';
    ...
    return (
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="mb-6">
                ...
                <p className="text-gray-500">Personaliza y configura el sistema según tus necesidades</p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div className="md:col-span-1">
                    <div className="bg-secondary rounded-lg shadow-md overflow-hidden">
                        ...
                        <nav className="p-2">
                            <a href="#" className="flex items-center gap-3 px-3 py-2 text-gray-800 bg-gray-100 rounded-md">
                            ...
                            <div className="ml-3">
                                ...
                                <div className="mt-2 text-sm text-primary-700">
                                    <p>
                                        ...
                                        del menú lateral para acceder a todas las configuraciones disponibles.
                                    </p>
                                </div>
                            </div>
                        </div>
